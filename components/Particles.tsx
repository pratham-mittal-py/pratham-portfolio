...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    // Add mouse enter and leave handlers for better hover detection
    const handleMouseEnter = () => {
      if (moveParticlesOnHover) {
        container.style.cursor = "none" // Optional: hide cursor for immersive effect
      }
    }
    ...
    const update = (t: number) => {
      ...
      if (moveParticlesOnHover) {
        ...
        particles.position.x += (0 - particles.position.x) * 0.02
        particles.position.y += (0 - particles.position.y) * 0.02
      }
